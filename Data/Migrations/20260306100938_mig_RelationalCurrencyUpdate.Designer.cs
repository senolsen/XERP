...
namespace Data.Migrations
{
    ...
    [Migration("20260306100938_mig_RelationalCurrencyUpdate")]
    partial class mig_RelationalCurrencyUpdate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Entities.TeklifKalem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Entities.Urun", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Entities.TeklifKalem", b =>
                {
                    b.HasOne("Core.Entities.Teklif", "Teklif")
                        .WithMany("Kalemler")
                        .HasForeignKey("TeklifId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Core.Entities.Urun", "Urun")
                        .WithMany()
